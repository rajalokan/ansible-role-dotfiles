...
" {{{ General colors
hi Normal				cterm=None		ctermfg=0		ctermbg=255					guifg=#444444	guibg=#F9F9F9
hi Cursor				cterm=None		ctermfg=239		ctermbg=15					guifg=#282828   guibg=#636363
hi CursorLine			cterm=None		ctermfg=90		ctermbg=84					guifg=NONE		guibg=#ffffcc
hi Visual				cterm=None		ctermfg=15		ctermbg=61					guifg=NONE		guibg=#99b1c4
hi VisualNOS							ctermfg=15		ctermbg=24					guifg=#FFFFFF   guibg=#204a87
hi Search				cterm=bold		ctermfg=236		ctermbg=228		gui=NONE	guifg=NONE		guibg=#99b1c4
hi LineNr								ctermfg=246		ctermbg=255					guifg=#acacac	guibg=#f9f9f9
hi StatusLine							ctermfg=238		ctermbg=250					guifg=#404040	guibg=#00ff00
